...
setwd("C:/Users/sam/Documents/GitHub/APSIMX_SeasonalCharacterization")
# Set working directory and code paths relative to the project folder
codes_dir <- getwd() # This assumes APSIMXimproved.R is in the same directory as app.R
Sys.setlocale("LC_ALL", "English_United States")
...
log_progress("finished getting soil data")
# Create APSIM files -----
...
apsimxfilecreate <- parLapply(cl, 1:nrow(trials_df), function(trial_n) {
  ...
  edit_apsimx(filename, src.dir = source_dir, wrt.dir = write_dir, overwrite = T, node = "Manager", manager.child = "Sow on a fixed date",
